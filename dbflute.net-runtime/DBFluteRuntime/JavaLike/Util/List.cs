...
namespace DBFluteRuntime.JavaLike.Util
{
    ...
    public interface List<E> : Collection<E>
    {
        ...
        // * @see #add(Object)
        // */
        //bool addAll<T>(Collection<T> c) where T : E;
        #endregion
	     ...
	     */
	    bool addAll<T>(int index, Collection<T> c) where T : E;

        #region interface duplicate...
        ///**
