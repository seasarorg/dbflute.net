...
public class QLog {
    ...
    private static readonly ILogger _log = ILoggerFactory.getLogger(QLog.class);LoggerFactory.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
