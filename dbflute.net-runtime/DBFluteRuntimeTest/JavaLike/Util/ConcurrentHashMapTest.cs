...
namespace DBFluteRuntimeTest.JavaLike.Util
{
    ...
    public class ConcurrentHashMapTest
    {
        ...
        {
            // ## Arrange ##
            ConcurrentHashMap<string, string> actualMap = new ConcurrentHashMap<string, string>();
        ...
        {
            // ## Arrange ##
            ConcurrentHashMap<string, string> actualEmpty = new ConcurrentHashMap<string, string>();
            ConcurrentHashMap<string, string> actualNotEmpty = new ConcurrentHashMap<string, string>();
